...
module.exports = {
  ...
  theme: {
    fontFamily: {
      // Brand/display face for the site header (loaded in static/index.html);
      // agents rebrand by swapping the leading family in their own config.
      display: ['"IBM Plex Serif"', 'Georgia', 'serif'],
      // App-wide default body face (Tailwind preflight reads fontFamily.sans).
      sans: [
        '"IBM Plex Sans"',
        '-apple-system',
        'BlinkMacSystemFont',
      ...
      // Procedural chrome: stamps, lane numbers, docket lines, case numbers.
    ...
    extend: {
      ...
      boxShadow: {
        ...
        chip: '0 2px 6px hsl(var(--primary) / 0.28)',
      },
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
      ...
      animation: {
        ...
        'word-in': 'word-in 0.3s ease forwards',
        'pop-in': 'pop-in 0.45s cubic-bezier(0.2, 1.4, 0.4, 1) both',
      },
    },
  },
